...
%DIF DEL old.tex   Mon Feb 19 16:03:31 2018
%DIF ADD new.tex   Mon Feb 19 14:49:14 2018
...
% (defaulted to 200X) and the ACM Cozzzpyright Data
...
%This template is used to done the task of generating a .tex file and .pdf of ACM research paper
...
%DIF TRADITIONAL PREAMBLE %DIF PREAMBLE
\RequirePackage[stable]{footmisc} %DIF PREAMBLE
\DeclareOldFontCommand{\sf}{\normalfont\sffamily}{\mathsf} %DIF PREAMBLE
\providecommand{\DIFaddtex}[1]{{\sf #1}} %DIF PREAMBLE
\providecommand{\DIFdeltex}[1]{{[..\footnote{removed: #1} ]}} %DIF PREAMBLE
...
%1st author
\alignauthor
     \DIFdelbegin \DIFdel{Shreyans Soni}\DIFdelend \DIFaddbegin \DIFadd{Mukesh Saini}\DIFaddend \\
       \affaddr{Dept. of Computer Science}\\
       \DIFdelbegin %DIFDELCMD < \affaddr{IIT Ropar}%%%
\DIFdelend \DIFaddbegin \affaddr{Nation University of Sigapore}\DIFaddend \\
       %\href{mailto:mksaini@comp.nus.edu.sg}{mksaini@comp.nus.edu.sg}
       \DIFdelbegin %DIFDELCMD < \email{2016csb1146@iitrpr.ac.in}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{mksaini@comp.nus.edu.sg}
\DIFaddend % 2nd. author
\alignauthor
       \DIFdelbegin \DIFdel{Divot Singh}\DIFdelend \DIFaddbegin \DIFadd{Raghudeep Gadde}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{Dept. of Computer Science}%%%
\DIFdelend \DIFaddbegin \affaddr{Dept. of ECE}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{IIT Ropar}%%%
\DIFdelend \DIFaddbegin \affaddr{Nation University of Sigapore}\DIFaddend \\
       \DIFaddbegin \email{elerdg@nus.edu.sg}
       \DIFaddend %\href{mailto:mksaini@comp.nus.edu.sg}{mksaini@comp.nus.edu.sg}
\DIFdelbegin %DIFDELCMD < \email{2016csb1039@iitrpr.ac.in}
%DIFDELCMD < %%%
\DIFdelend \and
\alignauthor
        \DIFdelbegin \DIFdel{Rohit Malik}\DIFdelend \DIFaddbegin \DIFadd{Shuicheng Yan}\DIFaddend \\
        \DIFdelbegin %DIFDELCMD < \affaddr{Dept. of Computer Science}%%%
\DIFdelend \DIFaddbegin \affaddr{Dept. of ECE}\DIFaddend \\
        \DIFdelbegin %DIFDELCMD < \affaddr{IIT Ropar}%%%
\DIFdelend \DIFaddbegin \affaddr{Nation University of Sigapore}\DIFaddend \\
        \DIFaddbegin \email{eleyans@nus.edu.sg}
        \DIFaddend %\href{mailto:mksaini@comp.nus.edu.sg}{mksaini@comp.nus.edu.sg}
\DIFdelbegin %DIFDELCMD < \email{2016csb1063@iitrpr.ac.in}
%DIFDELCMD < %%%
\DIFdelend \alignauthor
     \DIFdelbegin \DIFdel{Tejaswini Chintala}\DIFdelend \DIFaddbegin \DIFadd{Wei Tsang Ooi}\DIFaddend \\
        \affaddr{Dept. of Computer Science}\\
        \DIFdelbegin %DIFDELCMD < \affaddr{IIT Ropar}%%%
\DIFdelend \DIFaddbegin \affaddr{Nation University of Sigapore}\DIFaddend \\
        \DIFaddbegin \email{ooiwt@comp.nus.edu.sg}
        \DIFaddend %\href{mailto:mksaini@comp.nus.edu.sg}{mksaini@comp.nus.edu.sg}
\DIFdelbegin %DIFDELCMD < \email{2016csb1036@iitrpr.ac.in}
%DIFDELCMD < %%%
\DIFdelend }
...
%\category{I.2.10}{Information Systems Applications}{Miscellaneous}
...
\begin{figure}[t!]
  ...
  \begin{subfigure}[b]{0.5\linewidth}
    ...
    \subcaption{(d)}
  \end{subfigure}
  \subcaption{Figure 3: Occlusion detection. Figures (a)-(d) show the frames
...
\\\hline
     Performance&Type&Relationship&Duration&Frame Rate&Resolution \\\hline
     P1&Group Dance&12&4'&30&720^o480 \\\hline  
     P1&Group Dance&12&4'&30&720^o480 \\\hline  
     P1&Group Dance&12&4'&30&720^o480 \\\hline  
     P1&Group Dance&12&4'&30&720^o480 \\\hline\\  
\end{tabular}
...
\begin{tabular}{c|l}
\hline\\
A & Quality of vedio editing \\\hline
B & Visual quality of vedio editing \\\hline
C & Camera protorning vedion \\\hline
D & Interestingness (does video editing makes an interesting overview of the performance?) \\\hline
E & Overall quality (how likely you will recommend the video to a friend?)\\\hline
